...
//        assertTrue(OpenBSDBCrypt.checkPassword(SecurityUtils.replaceEnvVars("${envbc.MYENV:-tTt}",settings), "tTt".toCharArray()));
        assertTrue(BCrypt.verifyer().verify( "tTt".toCharArray(),SecurityUtils.replaceEnvVars("${envbc.MYENV:-tTt}",settings).getBytes(StandardCharsets.UTF_8)).verified);
...
//            assertTrue(OpenBSDBCrypt.checkPassword(SecurityUtils.replaceEnvVars("${envbc."+k+"}",settings), val.toCharArray()));
            assertTrue(BCrypt.verifyer().verify( val.toCharArray(),SecurityUtils.replaceEnvVars("${envbc."+k+"}",settings).getBytes(StandardCharsets.UTF_8)).verified);
